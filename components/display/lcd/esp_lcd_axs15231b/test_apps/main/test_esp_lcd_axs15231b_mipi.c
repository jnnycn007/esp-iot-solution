...
static char *TAG = "axs15231b_mipi_test";
...
static void test_init_lcd(void)
{
...
#if ESP_IDF_VERSION < ESP_IDF_VERSION_VAL(6, 0, 0)
    esp_lcd_dpi_panel_config_t dpi_config = AXS15231B_240_960_PANEL_60HZ_DPI_CONFIG(TEST_MIPI_DPI_PX_FORMAT);
#else
    esp_lcd_dpi_panel_config_t dpi_config = AXS15231B_240_960_PANEL_60HZ_DPI_CONFIG_CF(TEST_MIPI_DPI_PX_FORMAT);
#endif
    ...
    TEST_ESP_OK(esp_lcd_new_panel_axs15231b(mipi_dbi_io, &panel_config, &panel_handle));
...
TEST_CASE("test axs15231b to draw pattern with MIPI interface", "[axs15231b][draw_pattern]")
{
...
TEST_CASE("test axs15231b to draw color bar with MIPI interface", "[axs15231b][draw_color_bar]")
{
    ESP_LOGI(TAG, "Initialize LCD device");
    test_init_lcd();
...
TEST_CASE("test axs15231b to rotate with MIPI interface", "[axs15231b][mipi-rotate]")
{
